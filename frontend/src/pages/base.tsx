    ...
    <main className="landing">
      ...
      <section className="hero">
        <div>
          ...
          <Link to="/rules">Explore the rules</Link>
      ...
      <footer>
        BETTER THINKING. BRIGHTER TOMORROW. <span>CHANDIGARH UNIVERSITY · C SQUARE CLUB</span>
      </footer>
    </main>
  );
}
      ...
      <div className="columns">
        <section className="panel">
          ...
          <p>
            ...
            contribute independently. There is no chess clock. Engine analysis is private and may
            arrive after your move.
          </p>
          <p>
            Opening bonuses are restricted by the farming guard. Early resignations reverse the
            game’s points. Ask an administrator about the round’s settings.
          </p>
        </section>
        <section className="panel">
          ...
          {s && (
            <p>
              ...
              Draw {s.result.draw}, Loss {s.result.loss}.
            </p>
          )}
        </section>
      </div>
